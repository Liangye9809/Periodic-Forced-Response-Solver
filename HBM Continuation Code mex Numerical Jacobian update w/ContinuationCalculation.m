...
Coulombstructfc = CoulombFrictionParas(Coulombstruct);
% store the friction parameters in struct form, faster in calculation and
% proper in mex function
params.func.fc.kn = Coulombstructfc.kn;
params.func.fc.kt = Coulombstructfc.kt;
